...
ACLOCAL = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run tar
AUTOCONF = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run autoconf
AUTOHEADER = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run autoheader
AUTOMAKE = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /cygdrive/c/repos-git/dsmccgen/missing --run makeinfo
OBJEXT = o
...
install_sh = /cygdrive/c/repos-git/dsmccgen/install-sh
